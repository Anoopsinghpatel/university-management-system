...
public class Addteacher extends JFrame implements ActionListener {
    ...
    String qualification[] = {"B.Tech","Bsc","Bca","Bcom","Bcom(honr.)","BA","BBA","M.Tech","Msc","Mcom","MA","MCA","MBA"};
    ...
    String department[] = {"Computer Science","Electronics","Mechanical","Civil","finance", "marketing", "sales","Computer Application"};
